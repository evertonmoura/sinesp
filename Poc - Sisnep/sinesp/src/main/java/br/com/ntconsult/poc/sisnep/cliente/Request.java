...
public class Request {
	...
	public Request() {
		this.device = "Google Android SDK built for x86";
		this.operationalSystem = "ANDROID";
		this.majorVersion = "8.1.0";
		this.minorVersion = "4.3.2";
	...
	private void fillHeader(SOAPHeader soapHeader) throws SOAPException {
		...
		soapHeader.addHeaderElement(new QName(soapHeader.getNamespaceURI(), "h"))
				.setValue(String.valueOf(this.longitude));
		soapHeader.addHeaderElement(new QName(soapHeader.getNamespaceURI(), "i"))
				.setValue(String.valueOf(this.latitude));
		...
		soapHeader.addHeaderElement(new QName(soapHeader.getNamespaceURI(), "m"))
				.setValue("8797e74f0d6eb7b1ff3dc114d4aa12d3");
	}
